...
import contractABI from './CorrcontractABI';
...
const TokenPresaleUI = ({ onClose }) => {
  ...
  const CONTRACT_ADDRESS = '0x095B232D9feBbe122f9fE380478Ca7E23b062A9B';
...
/*       const contractBal = await tokenContract.balanceOf(CONTRACT_ADDRESS);
      ...
      const contractBal = await presaleContract.totalSupply();
      setContractBalance(formatEther(contractBal));
